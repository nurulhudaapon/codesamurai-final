/*
  ...
  - The values [reviwed] on the enum `issue_status` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "issue_status_new" AS ENUM ('reported', 'reviewed', 'resolved', 'flagged');
